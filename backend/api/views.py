...
class getMonthlySpendingVisuals(APIView):
    def get(self, request, *args, **kwargs):
        ...
        for cat in categories_list:
            individual_amount_for_category = ExpenseModel.objects.filter(category=cat, date__gte=last_month)
            ...
            monthly_spending_dict.update({cat: total_amount_spent_on_category})
